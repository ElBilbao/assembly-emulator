/**
  @progName Emulador de Ensamblador
...
// Duración default del intervalo de ejecución de las microoperaciones.
int secs = 3;
...
void loadFile() {
  // CAMBIAR:
  // Hacer que sólo se modifique la memoria si todo el archivo está correcto.
  ifstream file;
